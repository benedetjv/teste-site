...
const INITIAL_REGIONS: Region[] = [
    ...
    { id: 'shoulder-left', label: 'Ombro Esquerdo', icon: 'bi-universal-access', slug: '/blog/hernia-disco-x-protusao', view: 'front', top: '30.0%', left: '40%', description: 'Dores que irradiam para o braço esquerdo.' },
    { id: 'shoulder-right', label: 'Ombro Direito', icon: 'bi-universal-access', slug: '/blog/hernia-disco-x-protusao', view: 'front', top: '30.0%', left: '60%', description: 'Dores que irradiam para o braço direito.' },
    { id: 'elbow-left', label: 'Cotovelo Esquerdo', icon: 'bi-record-circle-fill', slug: '/blog/dor-na-coluna-quando-preocupar', view: 'front', top: '40.0%', left: '36.3%', description: 'Epicondilites e dores no cotovelo esquerdo.' },
    { id: 'elbow-right', label: 'Cotovelo Direito', icon: 'bi-record-circle-fill', slug: '/blog/dor-na-coluna-quando-preocupar', view: 'front', top: '40.0%', left: '63.7%', description: 'Epicondilites e dores no cotovelo direito.' },
    { id: 'wrist-left', label: 'Punho Esquerdo', icon: 'bi-hand-index', slug: '/blog/ergonomia-home-office', view: 'front', top: '46.3%', left: '33.2%', description: 'Túnel do carpo e tendinites (lado esquerdo).' },
    { id: 'wrist-right', label: 'Punho Direito', icon: 'bi-hand-index', slug: '/blog/ergonomia-home-office', view: 'front', top: '46.3%', left: '66.8%', description: 'Túnel do carpo e tendinites (lado direito).' },
    { id: 'hand-left', label: 'Mão/Dedos (E)', icon: 'bi-hand-index-thumb', slug: '/blog/ergonomia-home-office', view: 'front', top: '51.7%', left: '30.3%', description: 'Artrite e dores nas articulações dos dedos (E).' },
    { id: 'hand-right', label: 'Mão/Dedos (D)', icon: 'bi-hand-index-thumb', slug: '/blog/ergonomia-home-office', view: 'front', top: '51.7%', left: '69.7%', description: 'Artrite e dores nas articulações dos dedos (D).' },
    ...
    { id: 'hip-left', label: 'Quadril Esquerdo', icon: 'bi-gender-ambiguous', slug: '/blog/artrose-no-quadril-sintomas-e-cuidados', view: 'front', top: '49.0%', left: '43.0%', description: 'Impacto fêmoro-acetabular e artrose no quadril esquerdo.' },
    { id: 'hip-right', label: 'Quadril Direito', icon: 'bi-gender-ambiguous', slug: '/blog/artrose-no-quadril-sintomas-e-cuidados', view: 'front', top: '49.0%', left: '57.0%', description: 'Impacto fêmoro-acetabular e artrose no quadril direito.' },
        ...
        <div className="py-5 bg-white rounded-4 shadow-lg border-0 overflow-hidden position-relative" style={{ borderTop: '6px solid var(--azul-medio)' }}>
            <div className="container">
                <div className="row g-4 align-items-start">
                    ...
                    <div className="col-lg-5 col-md-7 order-1 order-lg-2 d-flex justify-content-center border-start border-end border-light">
                        <div
                            ref={containerRef}
